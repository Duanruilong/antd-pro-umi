...
import findRoute, {
  getUrlQuery,
} from '/Users/duanruilong/Github/antd-pro-umi/node_modules/_umi-build-dev@1.16.10@umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    // Umi UI Bubble
    require('../../../node_modules/_umi-plugin-ui@1.4.10@umi-plugin-ui/lib/bubble').default(
      {
        port: 3001,
        path: '/Users/duanruilong/Github/antd-pro-umi',
        currentProject: '',
        isBigfish: undefined,
      },
    );
...
(() => {
  ...
  window.GUmiUIFlag = require('../../../node_modules/_umi-build-dev@1.16.10@umi-build-dev/lib/plugins/commands/block/sdk/flagBabelPlugin/GUmiUIFlag.js').default;
